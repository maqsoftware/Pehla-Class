...
public class DownloadsDB {
    ...
    static synchronized DownloadsDB getDB(Context paramContext) {
    ...
    DownloadInfo getDownloadInfoByFileName(String fileName) {
        final SQLiteDatabase sqldb = mHelper.getReadableDatabase();
        Cursor itemcur = null;
        try {
    ...
    private long getIDForDownloadInfo(final DownloadInfo di) {
        return getIDByIndex(di.mIndex);
    }

    private long getIDByIndex(int index) {
    ...
    void updateDownloadCurrentBytes(final DownloadInfo di) {
     ...
     */
    void updateDownload(DownloadInfo di) {
        ...
        updateDownload(di, cv);
    }

    private void updateDownload(DownloadInfo di, ContentValues cv) {
        ...
        try {
            ...
            if (id != -1) {
                ...
                sqldb.insert(DownloadColumns.TABLE_NAME,
    ...
    private boolean updateMetadata(ContentValues cv) {
        final SQLiteDatabase sqldb = mHelper.getWritableDatabase();
    ...
    void updateMetadata(int apkVersion, int downloadStatus) {
        ContentValues cv = new ContentValues();
    ...
    void updateFromDb(DownloadInfo di) {
        final SQLiteDatabase sqldb = mHelper.getReadableDatabase();
        Cursor cur = null;
        try {
    ...
    private void setDownloadInfoFromCursor(DownloadInfo di, Cursor cur) {
    ...
    private DownloadInfo getDownloadInfoFromCursor(Cursor cur) {
    ...
    public static class MetadataColumns implements BaseColumns {
        static final String APKVERSION = "APKVERSION";
        static final String DOWNLOAD_STATUS = "DOWNLOADSTATUS";
        static final String FLAGS = "DOWNLOADFLAGS";
        ...
        static final String TABLE_NAME = "MetadataColumns";
    }

    public static class DownloadColumns implements BaseColumns {
        static final String INDEX = "FILEIDX";
        static final String URI = "URI";
        static final String FILENAME = "FN";
        static final String ETAG = "ETAG";

        static final String TOTALBYTES = "TOTALBYTES";
        static final String CURRENTBYTES = "CURRENTBYTES";
        static final String LASTMOD = "LASTMOD";

        static final String STATUS = "STATUS";
        static final String CONTROL = "CONTROL";
        static final String NUM_FAILED = "FAILCOUNT";
        static final String RETRY_AFTER = "RETRYAFTER";
        static final String REDIRECT_COUNT = "REDIRECTCOUNT";
        ...
        static final String TABLE_NAME = "DownloadColumns";
        static final String _ID = "DownloadColumns._id";
    }
