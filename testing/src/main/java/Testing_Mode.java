...
public class Testing_Mode {
        ...
        public static long timemillis = 0;        // testing date is by default "2019/04/12 16:00:45" set it using values from below functions
    public Testing_Mode(String myDate){
