...
class testingOperation:  
    ...
    def wait_for_extraction(self,driver):
        val = self.check_exists1('com.maq.xprize.kitkitschool.hindi:id/p',driver)
        while self.check_exists1('com.maq.xprize.kitkitschool.hindi:id/p',driver):
    ...
    def allow_permission(self,driver):
        ...
        sleep(2)
        return True
    # check tutorial is there or not
