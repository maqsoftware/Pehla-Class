...
import com.maq.pehlaclass.mainui.oc_playzone.OC_PlayZoneAsset;
...
import static com.maq.pehlaclass.mainui.OBViewController.MainViewController;
...
public class OCM_FatController extends OBFatController implements OBSystemsManager.TimeSynchronizationReceiver {
    ...
    public void startUnitInstanceTimeout(final OCM_MlUnitInstance unitInstance) {
        ...
        timeoutHandler.postDelayed(timeoutRunnable, unitInstance.mlUnit.targetDuration * 1000);
    }
    ...
    private void quitToTopMenu() {
        ...
        for (int i = controllers.size() - 1; i >= 1; i--) {
    ...
    */
    ...
    public boolean batteryStatusLow() {
        // this indicates that the battery status will never be shown as low
        // and hence no warning will be displayed without affecting other functions.
        return false;
    }
    ...
    public interface SectionOpeningCallback {
        void run(OCM_MlUnitInstance unitInstance, boolean success);
    }
