...
import com.example.testing.testingMode;
...
public class OCM_FatController extends OBFatController implements OBSystemsManager.TimeSynchronizationReceiver {
    ...
    private testingMode testing = new testingMode();  ////testing mode controller
    ...
    */
    ...
    public boolean communityModeActive() {
        if (testing.testingActive || testing.studySection) {
            return true;
